			...
			if(t_Byte != 0) {
				if(check_cnt == randNum) {
					...
					switch(t_random) {
						...
						case 2:
							m_MyView[x][y] = TYPE_ITEM_PLUSPLUS;
							break;

						case 3:
							m_MyView[x][y] = TYPE_ITEM_MINUSMINUS;
							break;

						case 4:
							m_MyView[x][y] = TYPE_ITEM_TWIST;
							break;

						case 5:
							m_MyView[x][y] = TYPE_ITEM_TWISTTWIST;
							break;
						...
						case 8:
							m_MyView[x][y] = TYPE_ITEM_CLEAR_DROP;
							break;

						case 9:
							m_MyView[x][y] = TYPE_ITEM_DELETE_FIELD_ITEM;
							break;

						case 10:
							m_MyView[x][y] = TYPE_ITEM_BLIND;
							break;
